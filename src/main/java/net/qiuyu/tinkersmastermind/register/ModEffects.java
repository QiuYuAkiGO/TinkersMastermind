...
import net.qiuyu.tinkersmastermind.effects.*;
...
public class ModEffects {
    ...
    public static RegistryObject<MobEffect> CORAL_HARDEN = EFFECTS.register("coral_harden",()->
    {
        return new CoralEffect(MobEffectCategory.BENEFICIAL, 0xFFB6C1, false);
    });
}
